...
using XRayAnalyzer.Objects.Converters;
...
namespace XRayAnalyzer.MVVM.View.SpectrumProcessing
{
    ...
    public partial class EditPeaksView : UserControl
    {
        ...
        {
            if (WpfPlotControl.SelectedPeak?.SignalPlot != null)
            {
                WpfPlotControl.PlotRemoveWithRefresh(WpfPlotControl.SelectedPeak.SignalPlot);
                WpfPlotControl.SelectedPeak = null;
            }
        ...
        private void Button_UniversalConfirm_Click(object sender, RoutedEventArgs e) 
        { 
            if(ViewModel.IsAddingPeak) 
            {
                this.Button_ConfirmNewPeak_Click(sender, e);
            }
            else if (ViewModel.IsSearchingPeak) 
            {
                this.Button_SearchPeaksConfirm_Click(sender, e);
            }
            else if (ViewModel.IsEditingPeak) 
            {
                this.Button_ConfirmEditedPeak_Click(sender, e);
            }
            
        }

        private void Button_UniversalCancel_Click(object sender, RoutedEventArgs e)
        {
            if (ViewModel.IsAddingPeak)
            {
                this.Button_CancelNewPeak_Click(sender, e);
            }
            else if (ViewModel.IsSearchingPeak)
            {
                this.Button_SearchPeaksCancel_Click(sender, e);
            }
            else if (ViewModel.IsEditingPeak)
            {
                this.Button_CancelEditedPeak_Click(sender, e);
            }

        }

        private void RadioButton_AddPeak_Unchecked(object sender, RoutedEventArgs e)
        {
            this.Button_CancelNewPeak_Click(sender, e);
        }

        private void RadioButton_SearchPeaks_Unchecked(object sender, RoutedEventArgs e)
        {
            this.Button_SearchPeaksCancel_Click(sender, e);
        }

        private void RadioButton_EditPeak_Unchecked(object sender, RoutedEventArgs e) 
        {
            this.Button_CancelEditedPeak_Click(sender, e);
        }
